 ...
 * Class.
 */
if ( ! class_exists( 'Ht_Easy_Ga4_Trial' ) ) {
    final class Ht_Easy_Ga4_Trial {
        ...
        public function __construct() {
            ...
            $this->screen_ids =  array('toplevel_page_ht-easy-ga4-setting-page', 'ht-easy-ga4_page_ga4-recommendations');
