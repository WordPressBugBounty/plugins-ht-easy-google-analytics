...
if ( ! class_exists( 'Notice_Handler' ) ){
    class Notice_Handler{
        ...
        public function __construct(){
            ...
            add_action( 'wp_ajax_htga4_notices', [ $this, 'ajax_dismiss' ] );
        }
        ...
        public function ajax_dismiss() {
			...
			if ( ! apply_filters( 'htga4_notice_user_cap_check', current_user_can( $capability ) ) ) {
                $error_message = [
            ...
            if( !wp_verify_nonce( $nonce, 'htga4_notices_nonce') ) {
                $error_message = [
            ...
            $scripts = "jQuery(document).ready( function($) {
                $( '.hastech-admin-notice.is-dismissible' ).on( 'click', '.notice-dismiss,.hastech-notice-close', function(e) {
                    ...
                    let noticeWrap = $( this ).parents( '.hastech-admin-notice' ),
                        ...
                        noticeNonce = '".esc_html( wp_create_nonce( 'htga4_notices_nonce' ) )."';
        ...
        private function prepare_notice( $notice_data ){
            ...
            $hide_screen = ['plugins','plugin-install','update','update-core','shoplentor_page_htga4_templates'];
